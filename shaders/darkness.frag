...
if(vOccluded != 0.0) {
	...
	if(vOccluded != 1.0) {
		...
		vec3 vertA = vVertA / vProportionConstant,
			vertB = vVertB / vProportionConstant;
...
// if(intersect(uVOVerts[52].xz, uVOVerts[].xz, uPlayerPosition.xz, vWorldPosition.xz)) {
// 	gl_FragColor *= 0.2;
// }
