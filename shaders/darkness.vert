// Modified THREE.js lambert shader.
// Modified areas are identified by many slashes
/////////////////////////
...
varying float vProportionConstant;
...
// uVOVerts/EdgesLength are constants added by a define block. See material.js.
...
// To reconstruct non-varying varyings in the fragment shader
// http://bytecode-rhapsody.blogspot.ca/2014/09/glsl-passing-uninterpolated-varyings.html
vProportionConstant = 1.0;

for(int i = 0; i < uVOEdgesLength; i += 2) {

	edgeVertA = uVOEdges[i];
	edgeVertB = uVOEdges[i + 1];

	vertA = uVOVerts[edgeVertA];
	vertB = uVOVerts[edgeVertB];
...
///////////////////////////////////////
		...
		// removed vec4 worldPosition since it is defined above
